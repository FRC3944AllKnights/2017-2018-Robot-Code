...
public class TPALifter {
	...
	double setpoint;
	double position1 = 0; //different
	double position2 = 3; //positions
	double position3 = 29.5; //in
	double position4 = 40.5; //inches
	...
	void upPID(){
		lifter.configClosedloopRamp(.5, 0);
		lifter.config_kP(0, .048, 0);
		lifter.config_kI(0, 0, 0);
		lifter.config_kD(0, .029, 0);
		SmartDashboard.putNumber("Encoder: ", lifter.getSelectedSensorPosition(0));
